        ...
        <footer className="relative bg-[#09090f] w-full pt-20 pb-12 border-t border-[rgba(255,255,255,0.06)] text-[#e4e0f1] overflow-hidden">
            ...
            <div className="max-w-[1280px] mx-auto px-6 grid grid-cols-1 lg:grid-cols-12 gap-12 items-start relative z-10">
                ...
                <div className="lg:col-span-5 flex flex-col gap-6">
                    <a href="https://cvgrid.in" className="flex items-center gap-3 no-underline group">
                        <img 
                            src="/logo.png" 
                            alt="CVGrid Logo" 
                ...
                <div className="lg:col-span-7 grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-12 w-full">
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        <a className="text-[#c7c4d7] hover:text-white transition-colors duration-200 no-underline text-sm py-1" href="https://cvgrid.in/contact" style={{ fontFamily: "var(--font-inter), sans-serif" }}>
                            Contact Us
                        </a>
                        <a className="text-[#c7c4d7] hover:text-white transition-colors duration-200 text-sm py-1 no-underline" href="https://cvgrid.in/blog" style={{ fontFamily: "var(--font-inter), sans-serif" }}>
                            Resources &amp; Blog
                        </a>
                    </div>
            ...
            <div className="max-w-[1280px] mx-auto px-6 mt-16 pt-8 border-t border-[rgba(255,255,255,0.06)] flex flex-col md:flex-row justify-between items-center gap-6 text-[#c7c4d7] text-xs relative z-10">
                ...
                <div className="flex flex-wrap gap-4 md:gap-6 font-medium order-1 md:order-2">
                    <a className="text-[#c7c4d7] hover:text-white transition-colors duration-200 no-underline" href="https://cvgrid.in/about">
                        About Us
                    </a>
                    <a className="text-[#c7c4d7] hover:text-white transition-colors duration-200 no-underline" href="https://cvgrid.in/blog">
                        Blog
                    </a>
                    <a className="text-[#c7c4d7] hover:text-white transition-colors duration-200 no-underline" href="https://cvgrid.in/privacy">
                        Privacy Policy
                    </a>
                    <a className="text-[#c7c4d7] hover:text-white transition-colors duration-200 no-underline" href="https://cvgrid.in/terms">
                        Terms of Service
                    </a>
                    <a className="text-[#c7c4d7] hover:text-white transition-colors duration-200 no-underline" href="https://cvgrid.in/contact">
                        Contact Us
                    </a>
                </div>
            </div>
