                ...
                <div className="lg:col-span-7 grid grid-cols-2 md:grid-cols-3 gap-8 md:gap-12 w-full">
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        <a 
                            ...
                            target="_blank" 
                            rel="noopener noreferrer" 
                            className="mt-2 inline-flex items-center gap-3 px-3.5 py-2 rounded-xl bg-white hover:bg-neutral-100 text-black shadow-lg hover:shadow-white/20 transition-all duration-300 hover:scale-[1.03] active:scale-[0.98] text-decoration-none group w-fit"
